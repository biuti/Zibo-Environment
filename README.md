...
you need to register, and you'll get a LOGON code by email
...
1. ### XPPython3
    ...
    - unzip the packet and move XPPython3 folder to X-Plane 12 plugin folder

        ![XPPython3](pictures/image-1.png)

    - If your OS requires, remove Antivirus check on plugin folder
    - >[!IMPORTANT]\
    start X-Plane 12 and let XPPython3 download all the needed libraries. It will notify when it's done. You can then close X-Plane

        ![XPPython3 downloading](pictures/image-2.png)
